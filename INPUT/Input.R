...
#profile for ten outputs which are the ten values of chlorophyll for ten
...
write.table(INPUTS,file="profil_input.dat",col.names=F,row.names=F)

#to have the depths de-normalized :
z0  <-  Z0_func(fluo,depth)
depth_denormalized <- seq(0,1.3,0.14) * z0
